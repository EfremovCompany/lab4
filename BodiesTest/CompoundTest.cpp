...
{
	// TODO: use `auto compound = make_shared<CCompound>();`
...
{
	// TODO: use `auto compound = make_shared<CCompound>();`
	shared_ptr<CCompound> compound1 = make_shared<CCompound>();
	shared_ptr<CCompound> compound2 = make_shared<CCompound>();
